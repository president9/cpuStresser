...
std::atomic<bool> keep_running_sc;
std::mutex cout_mutex_sc;
...
void simple_stress_int(size_t core_id) {
    ...
    {
        std::lock_guard<std::mutex> lock(cout_mutex_sc);
